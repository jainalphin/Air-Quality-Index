# -*- coding: utf-8 -*-
"""
Created on Tue Nov 10 11:29:42 2020
...
def data_combine(year,chunk_size):
    for i in pd.read_csv('Data/Real-Data2/real_'+str(year)+'.csv',chunksize=chunk_size):
...
if __name__=='__main__' :
    if not os.path.exists('Data/Real-Data2'):
        os.makedirs('Data/Real-Data2')
    for year in range(2013,2017):
        final_data=[]
        with open('Data/Real-Data2/real_'+str(year)+'.csv','w') as csvfile:
            #making csv file
        ...
        with open('Data/Real-Data2/real_'+str(year)+'.csv','a') as csvfile:
    ...
    with open('Data/Real-Data2/Real_Combine.csv','w') as csvfile:
            wr =csv.writer(csvfile, dialect='excel')
            #first row 
            wr.writerow(
                ['T', 'TM', 'Tm', 'SLP', 'H', 'VV', 'V', 'VM', 'PM 2.5'])
    ...
    df=pd.read_csv('Data/Real-Data2/Real_Combine.csv')
